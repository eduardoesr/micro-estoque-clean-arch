package br.com.microservice.estoque.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EstoqueProdutoError.EstoqueProdutoNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ResponseEntity<Object> handleEstoqueProdutoNotFound(EstoqueProdutoError.EstoqueProdutoNotFoundException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handleEstoqueProdutoAlreadyExists(EstoqueProdutoError.EstoqueProdutoAlreadyExistsException ex, WebRequest request) {
        return ResponseEntity
    ...
    @ExceptionHandler(EstoqueProdutoMongoError.EstoqueProdutoPersistenceException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public ResponseEntity<Object> handlePersistenceException(EstoqueProdutoMongoError.EstoqueProdutoPersistenceException ex, WebRequest request) {
        return ResponseEntity
                .internalServerError()
